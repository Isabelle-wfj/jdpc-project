<template>
    ...
    <div class="yd-slider" ref="slider">
        ...
        <div class="jd-common" v-if="itemsArr.length > 1 && showActiveIndex">
            <div class="yd-carousel">
                <div class="carousel-title"></div>
                <div class="jd-slide-page"><input class="jd-strong" 
                v-model="currentIndex > itemsArr.length  ? 1 : currentIndex< 1 ? itemsArr.length : currentIndex">/{{itemsArr.length}}</div>
            </div>
        </div>
